      ...
      <div class="top-header" :class="{ hidden: !topHeaderVisible }">
        <div class="row">
          ...
          <div class="col-6">
            <div class="top-right">
              <p>
                this is <a href="">RaxG.</a> A template for games, clans &
                esports
              </p>
        ...
        <nav class="nav row">
          ...
          <div class="menu col-4">
            <ul>
              ...
              <li
                v-for="(menu, index) in filteredMenus.slice(0, 3)"
                :key="index"
              ...
              >
                <a :href="menu.url"
                  ...
                  <ModaleComponent
                    v-if="currentModale === menu.subMenu"
          ...
          <div class="menu col-4">
            <ul>
              ...
              <li
                v-for="(menu, index) in filteredMenus.slice(3)"
                :key="index"
                @mouseenter="modaleOn(menu.subMenu)"
                @mouseleave="modaleOff()"
              >
